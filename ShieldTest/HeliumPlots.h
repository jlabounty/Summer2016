...
void Solenoid_calib_single_python(std::string file_path, std::string summary_file_path, std::string ten_file1_txt, std::string title, TCanvas &c00, TLegend &leg, int color)
{
//Measurement Files

	std::string python_input = "python plot_output.py "+file_path+" "+ten_file1_txt+" True";

	gSystem->Exec(python_input.c_str());
	ten_file1_txt = ten_file1_txt.substr(1, ten_file1_txt.size() - 2);
