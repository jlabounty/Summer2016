	...
	//Overlapping sample    
		...
		*leg);
        ...
        calibration_plot_single(
                ...
                "Large Non-Overlapping Cylinder",
		*c00,
		*leg);
*/
	//Small overlap	with tape
	calibration_plot_single(
		...
		"Small Overlapping Cylinder (Folded with Tape)",
		*c00,
		*leg);	//Title of plot

	//Small overlap against tape	
	calibration_plot_single(
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160621_113538.txt",	//Room temperature calibration 
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160621_124047.txt",	//Before baking
		"Small Overlapping Cylinder (Folded Against Tape)",
		*c00,
		*leg);	//Title of plot
